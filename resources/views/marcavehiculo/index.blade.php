...
@php
	...
	$breadcrumbs = array(
		...
		'1' => array('nombre' => 'Módulo de Marca Vehiculo', 'link' => '' , 'active' => true)
	);

@endphp

@section('title', 'Módulo de Marca Vehiculo')

@section('pageHeader','Módulo de Marca Vehiculo')
			...
			<div class="col-md-12">
				<div class="panel panel-inverse">
			        ...
			        <div class="panel-heading">
			            <h4 class="panel-title">Lista de Marca Vehiculo</h4>
			        ...
			        <div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								...
								@include('marcavehiculo.partials.list')
							</div>
						</div>	
