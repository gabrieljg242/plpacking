...
@php
	...
	$breadcrumbs = array(
		...
		'1' => array('nombre' => 'Módulo de Tipo Vehiculo', 'link' => '' , 'active' => true)
	);

@endphp

@section('title', 'Módulo de Tipo Vehiculo')

@section('pageHeader','Módulo de Tipo Vehiculo')
			...
			<div class="col-md-12">
				<div class="panel panel-inverse">
			        ...
			        <div class="panel-heading">
			            <h4 class="panel-title">Lista de Tipo Vehiculo</h4>
			        ...
			        <div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								...
								@include('tipovehiculo.partials.list')
							</div>
						</div>	
