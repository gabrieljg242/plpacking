    ...
    <tbody>
        ...
        <tr class="text-center">
            ...
            <td>
                ...
                <a href="{{ route('proveedor.edit', encrypt($proveedor->id)) }}" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="Ver detalle"><i class="fas fa-eye fa-fw"></i></a>
                @endcan
            </td>
        </tr>
        @endforeach
                ...
                @can('proveedor.create')
                    {
                        ...
                        action: function ( e, dt, node, config ) {
                            location.href = '{{ url("proveedor/create") }}';
                        }
                    },
                @endcan
            ]
