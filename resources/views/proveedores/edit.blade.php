...
$breadcrumbs = array(
    ...
    '1' => array('nombre' => 'Módulo de Proveedor', 'link' => 'proveedor' , 'active' => ''),
    '2' => array('nombre' => 'Detalle Datos Proveedor', 'link' => '' , 'active' => true)
);

@endphp

@section('title', 'Detalle Datos Proveedor')

@section('pageHeader','Detalle Datos Proveedor')
    ...
    <div class="col-md-12">
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                {!! Form::model($proveedor,['route' => ['proveedor.update',encrypt($proveedor->id)] ,'method' => 'PUT', 'id' => 'form']) !!}
