...
@php
	...
	$breadcrumbs = array(
		...
		'1' => array('nombre' => 'Módulo de Procedencias', 'link' => '' , 'active' => true)
	);

@endphp

@section('title', 'Módulo de Procedencias')

@section('pageHeader','Módulo de Procedencias')
			...
			<div class="col-md-12">
				<div class="panel panel-inverse">
			        ...
			        <div class="panel-heading">
			            <h4 class="panel-title">Lista de Procedencias</h4>
			        ...
			        <div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								...
								@include('procedencias.partials.list')
							</div>
						</div>	
